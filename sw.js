...
const CACHE = 'phub-v15';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/style.css?v=15',
  './js/core.js?v=15', './js/charts.js?v=15', './js/dashboard.js?v=15', './js/finance.js?v=15',
  './js/health.js?v=15', './js/study.js?v=15', './js/work.js?v=15', './js/more.js?v=15', './js/app.js?v=15',
