...
const CACHE = 'phub-v10';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/style.css?v=10',
  './js/core.js?v=10', './js/charts.js?v=10', './js/dashboard.js?v=10', './js/finance.js?v=10',
  './js/health.js?v=10', './js/study.js?v=10', './js/work.js?v=10', './js/more.js?v=10', './js/app.js?v=10',
