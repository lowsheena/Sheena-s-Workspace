...
const CACHE = 'phub-v18';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/style.css?v=18',
  './js/core.js?v=18', './js/charts.js?v=18', './js/dashboard.js?v=18', './js/finance.js?v=18',
  './js/health.js?v=18', './js/study.js?v=18', './js/work.js?v=18', './js/more.js?v=18', './js/app.js?v=18',
