...
const CACHE = 'phub-v11';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/style.css?v=11',
  './js/core.js?v=11', './js/charts.js?v=11', './js/dashboard.js?v=11', './js/finance.js?v=11',
  './js/health.js?v=11', './js/study.js?v=11', './js/work.js?v=11', './js/more.js?v=11', './js/app.js?v=11',
