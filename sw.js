...
const CACHE = 'phub-v19';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/style.css?v=19',
  './js/core.js?v=19', './js/charts.js?v=19', './js/dashboard.js?v=19', './js/finance.js?v=19',
  './js/health.js?v=19', './js/study.js?v=19', './js/work.js?v=19', './js/more.js?v=19', './js/app.js?v=19',
