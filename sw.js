...
const CACHE = 'phub-v12';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/style.css?v=12',
  './js/core.js?v=12', './js/charts.js?v=12', './js/dashboard.js?v=12', './js/finance.js?v=12',
  './js/health.js?v=12', './js/study.js?v=12', './js/work.js?v=12', './js/more.js?v=12', './js/app.js?v=12',
